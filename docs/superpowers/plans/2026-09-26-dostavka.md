...
final class DeliveryController
{
    ...
    public function cantDo(array $params): void
    {
        ...
        if (P::allows(P::DROP, $d, $me, self::driverOf($d))) {
            if (!$this->deliveries->release((int) $d['id'])) { $this->back((int) $d['id'], 'error', 'Заявка уже обработана.'); return; }
    ...
    public function deliver(array $params): void
    {
        ...
        if (!$this->deliveries->deliver((int) $d['id'], $sum, date('Y-m-d H:i:s'))) {
    ...
    public function cancel(array $params): void
    {
        ...
        // Кому сказать: исполнителю, если взяли; иначе водителю, если просьба к поездке ждала его.
        $to = $d['carrier_id'] !== null ? [(int) $d['carrier_id'], (string) $d['car_email']]
            : ($d['status'] === 'requested' ? [(int) $d['trip_driver_id'], (string) $d['driver_email']] : null);
        if ($to !== null) {
