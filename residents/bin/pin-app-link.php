...
$text = implode("\n", [
    '📱 Портал жителей «Сказочный Край»',
    '',
    'Дневники поместий, инструменты и книги, поездки, совместные закупки, Общий дом и справочник соседей — всё в одном приложении.',
    '',
    $appLink,
    '',
    'Вход автоматический, отдельный пароль не нужен. Ссылка дана открытым текстом: так Telegram спросит подтверждение только при первом запуске.',
]);
