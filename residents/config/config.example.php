...
return [
    ...
    'telegram' => [
        ...
        // Отдельный бот раздела «Попечительский совет» — нужен, чтобы ярлык на
        // главном экране назывался «Попечительский совет» и открывал /sovet.
        // Пусто → вход в /sovet проверяется общим ботом жителей (bot_token выше).
        'council_bot_token' => getenv('SOVET_BOT_TOKEN') ?: '',
    ],
