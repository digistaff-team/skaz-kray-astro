        ...
        <li class="sovet-agenda-item<?= $disc ? ' is-discussed' : '' ?>">
            ...
            <div class="sovet-agenda-actions">
                <?php if ($isEditor): ?>
                    ...
                    <form method="post" action="/sovet/povestka/obsuzhdeno"><?= Csrf::field() ?><input type="hidden" name="id" value="<?= $iid ?>"><button class="res-link-btn" type="submit"><?= $disc ? 'вернуть' : 'обсуждено' ?></button></form>
                <?php endif; ?>
