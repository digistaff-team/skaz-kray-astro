...
final class AppDashboardTest extends TestCase
{
    ...
    /** Каталоги инструментов/книг/поездок JOIN-ят families — нужна строка семьи. */
    ...
    private function seed(): int
    {
        ...
        // Дневник семьи: 2 записи, последняя — на проверке (pending по умолчанию).
    ...
    {
        $familyId = $this->seed();
        $r = (new AppDashboard())->build($familyId, 'С. Шубин', '2026-09-04');
